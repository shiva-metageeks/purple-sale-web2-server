...
export const addToCartArbitrum = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getCartItemsArbitrum = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getCartItemsByWalletArbitrum = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const deleteCartItemArbitrum = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    try {
