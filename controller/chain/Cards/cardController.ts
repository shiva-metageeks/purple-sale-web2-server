...
import Cart from "../../../model/chain/Cards/cardModel.js";
...
export const getCartItemsByWalletArbitrum = catchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const deleteCartItemArbitrum = catchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
