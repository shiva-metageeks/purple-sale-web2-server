import PrivateSaleData from '../../../../model/Multichain/Avalanche/Privatesale/privateSaleModel.js';
import catchAsyncError from '../../../../middleware/catchAsyncError.js';
import ErrorHandler from '../../../../utils/errorHandler.js';
export const saveDataAvalanche = catchAsyncError(async (req, res, next) => {
    try {
        const { id, title, logoUrl, bgLogoUrl, websiteUrl, facebook, twitter, github, instagram, discord, reddit, youtube, description, } = req.body;
...
//# sourceMappingURL=privateSaleController.js.map