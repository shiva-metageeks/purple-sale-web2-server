...
export const addToCartAvalanche = catchAsyncError(async (req, res, next) => {
    try {
...
export const getCartItemsAvalanche = catchAsyncError(async (req, res, next) => {
    try {
...
export const getCartItemsByWalletAvalanche = catchAsyncError(async (req, res, next) => {
    try {
...
export const deleteCartItemAvalanche = catchAsyncError(async (req, res, next) => {
    try {
